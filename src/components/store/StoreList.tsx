...
const StoreImageGallery = (props: StoreImageGalleryProps): React.JSX.Element => {
    return (
        <div id={"storeElementGallery" + props.store.id} className="h-56 w-128 md:w-56 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative" onClick={() => props.onClick(props.store.id)}>
