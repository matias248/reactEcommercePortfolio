...
import { type StoreDTO, StoresKeysToNotDisplayInDetails } from "../../models/Store";
...
export const StoreDetailPage = (): React.JSX.Element => {
                ...
                <div className="max-w-[1000px] mx-auto w-[90%] rounded-lg">
                    <div className="text-3xl text-center mb-1 dark:text-white flex justify-end" >
                        <button onClick={() => {
                            ...
                            id="gotoEditButton" className="max-h-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm w-auto px-2 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Go to Edit</button>
                    </div>
                                ...
                                {typeof element[1] === 'object' && <>
                                    {
                                        Object.entries(element[1]).map((currentValue,index2) => {
                                            ...
                                            return <li key={index+"-"+index2} id={"displayStoreElement"+index+"-"+index2} className="flex justify-between border border-gray-200 rounded-lg shadow-xs bg-slate-400 dark:bg-gray-500 dark:border-gray-700 gap-2 margin-top-2">
