...
import { type ProductDTO, ProductKeysToNotDisplayInDetails } from "../../models/Product";
                ...
                <div className="max-w-[1000px] mx-auto w-[90%] rounded-lg">
                    ...
                    <ul className="space-y-2 bg-slate-100 border-gray-200 dark:bg-gray-800  dark:text-white rounded-lg">
                        {Object.entries(product).filter((element) => {
                            ...
                            return <li id={"displayProductElement" + index} key={index} className="flex justify-between border border-gray-200 rounded-lg shadow-xs bg-slate-400 dark:bg-gray-500 dark:border-gray-700 gap-2 margin-top-2">
