    ...
    return (<>
        <div id="orderConfirmModal" className="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-[calc(100%)]">
            <div className="relative w-full max-w-2xl max-h-full m-4 " ref={ref}>
                <div className="relative bg-white rounded-lg shadow-xs dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-800">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b border-gray-300 rounded-t dark:border-gray-600">
